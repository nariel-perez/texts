...
\begin{figure}[!ht]
	\centering
	\includegraphics[width=0.80\linewidth]{Figures/graph-anexos/esquema.png}
...
Originalmente, todas las cadenas de pol\'imeros conectan dos entrecruzamientos, pero como resultado del procedimiento mencionado anteriormente, algunas cadenas quedan pendientes en la superficie de la red y se conectan solo a un entrecruzamiento. Estas cadenas colgantes contienen el 22\% del n\'umero total de segmentos.
