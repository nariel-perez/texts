...
\begin{titlepage}
  \TitleBlock{\includegraphics[scale = 1.5]{Figures/escudo}}
 % \TitleBlock{\Huge\scshape\insertinstitution}
   \TitleBlock{\Large\scshape\insertinstitution}
  \TitleBlock[\bigskip]{\scshape\insertfaculty}
   \TitleBlock[\bigskip]{\insertdepartment}
    %\hline
   \TitleBlock{\textbf{\underline{Trabajo de Tesis Doctoral}}}
  \TitleBlock{\scshape\inserttitle}
  %\hline
  \TitleBlock{
    \underline{\textbf{Tesista:}} \scshape\insertauthor \\
