...
En esta secci\'on nos valdremos de una  red polim\'erica entrecruzada que da estructura a un  film polim\'erico , un hidrogel. 
Como se mencion\'o anteriormente los films son materiales ampliamente investigados para aplicaciones biom\'edicas. \addcite 
...
Este sistema adem\'as de poder explicar la fisicoqu\'imica que lo envuelve, y poder de respuesta a comportamientos observados experimentalmente \addcite fue una introducci\'on  en la teor\'ia molecular.
...
\end{align}
\noindent en donde $v_\gamma$ , $v_\lambda$ y $v_{MAA}$ son los vol\'umenes moleculares de los segmentos $\gamma$ de las especiesl libres, $\lambda$  en la prote\'ina y los segmentos de $MAA$ del film respectivamente.
