...
$v_{MAA}$ es el volumen molecular del segmento de MAA. El subindice $i$ recorre los tipos de segmentos que componen al film ($i = MAA/VA/crosslink$), para los cuales se define:
...
Las unidades titullables pueden estar en esta protonado $\tau p$ o desprotonado $\tau d$, los cuales poseen su potenciales qu\'imicos est\'andar $\mu^0_{\tau,p}$ y $\mu^0_{\tau,d}$ respectivamente. 
...
$\left<\rho_{pro,\lambda}(r)\right>$ is defined in the same way as %\cref{eq:segments_pro_si}.
