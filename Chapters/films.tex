...
A continuaci\'on se mostrara la optimizaci\'on de este gran potencial respecto de los funcionales de  eq. \ref{eq:funcionales}, a los cuales se debe adicionar el potencial $\Pi(z)$.
