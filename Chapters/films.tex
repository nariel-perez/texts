...
Los hidrogeles consisten en una red de pol\'imeros reticulados altamente hidratados y generalmente biocompatibles. Estos materiales pueden parecerse a los tejidos biol\'ogicos y pueden ser dise\~nados para responder a cambios ambientales como variaciones en la temperatura, el pH, la fuerza i\'onica y la concentraci\'on de algunas biomol\'eculas. Como resultado, los hidrogeles polim\'ericos son actualmente candidatos prometedores para el desarrollo de una variedad de biomateriales con aplicaciones en biosensores, ingenier\'ia de tejidos, regeneraci\'on \'osea, materiales biomim\'eticos, administraci\'on de medicamentos y muchas otras aplicaciones biom\'edicas. El entorno acuoso dentro de los hidrogeles puede proteger a las prote\'inas de la desnaturalizaci\'on y agregaci\'on, mientras que estas se mantienen activas y estructuradas cuando se liberan de los hidrogeles. En la administraci\'on oral de medicamentos, los hidrogeles con respuesta al pH han sido ampliamente investigados como veh\'iculos funcionales que pueden encapsular y liberar prote\'inas, evitando su degradaci\'on en el entorno gastrointestinal. El control de la funci\'on y el comportamiento de un biomaterial requiere comprender su interacci\'on con las prote\'inas. Por ejemplo, las lentes de contacto basadas en \'acido poli(metacr\'ilico) (PMAA) con respuesta al pH est\'an expuestas al fluido lagrimal, que contiene cientos de prote\'inas. La adsorci\'on de algunas de estas prote\'inas debe evitarse, ya que afecta la comodidad de uso y puede provocar inflamaci\'on; sin embargo, la adsorci\'on selectiva de prote\'inas con propiedades antibacterianas y antiinflamatorias, como la lisozima, podr\'ia ser beneficiosa. Sin embargo, la interacci\'on entre prote\'inas y superficies polim\'ericas est\'a gobernada por una compleja interacci\'on entre diferentes grados de libertad. La capacidad tanto del adsorbato como del material adsorbente para protonar/deprotonar, regular su carga el\'ectrica y modificar el entorno cercano, contribuye a esta complejidad.

\section{Encapsulado y Liberaci\'on de medicamentos}


Los sistemas de delivery de drogas son dispositivos que permiten administrar f\'armacos de forma controlada y  localizada en el organismo, mejorando la eficacia de su componente activio y reduciendo as\'i los efectos secundarios. Los hidrogeles son materiales compuesto por cadenas polimérica entrecruzadas que pueden absorber grandes cantidades de agua, o el solvente en donde se encuentren. Los hidrogeles son excelente candidatos como sistemas de delivery de drogas porque tienen propiedades como la biocompatibilidad, la sensibilidad a estí\'iulos externos y la capacidad de liberar el f\'armacos por difusi\'on (al colapsar) o por hinchamiento. 

Los primeros hidrogeles....
Ejemplos de hidrogeles usados en terapias... investigacion de los estimulos.



Uno de los principales desaf\'ios en el campo de la administraci\'on de f\'armacos es lograr una entrega controlada y sostenida de los medicamentos al sitio de acci\'on deseado en el organismo. Los hidrogeles polim\'ericos ofrecen una soluci\'on prometedora a este desaf\'io debido a sus propiedades f\'isicas y qu\'imicas ajustables, que les permiten encapsular y liberar f\'armacos de manera controlada.

Existen varias t\'ecnicas para la preparaci\'on de hidrogeles polim\'ericos utilizados en sistemas de administración de f\'armacos. Una de las m\'as comunes es la polimerizaci\'on de mon\'omeros hidrof\'ilicos en presencia de un agente entrecruzante. Esto permite formar una red tridimensional de pol\'imeros que retiene grandes cantidades de agua. La estructura porosa resultante del hidrogel permite la difusi\'on controlada del f\'armaco a trav\'es de la matriz polim\'erica.

La capacidad de los hidrogeles polim\'ericos para liberar f\'armacos de manera controlada puede ajustarse mediante la modificaci\'on de la composici\'on qu\'imica del hidrogel, incluyendo el tipo de pol\'imero utilizado, la densidad de entrecruzamiento y la presencia de grupos funcionales. Estos factores influyen en la velocidad de absorci\'on y desorci\'on del f\'armaco, lo que a su vez afecta la liberaci\'on del mismo.

Adem\'as de su capacidad de liberaci\'on controlada de f\'armacos, los hidrogeles polim\'ericos tambi\'en pueden proteger los f\'armacos de la degradaci\'on enzim\'atica y mejorar su estabilidad durante el almacenamiento. Esto es especialmente importante para aquellos f\'armacos que son sensibles a las condiciones del entorno, como la temperatura o el pH.

El uso de hidrogeles polim\'ericos como sistemas de administraci\'on de f\'armacos ha demostrado beneficios significativos en varios campos de la medicina. Por ejemplo, se han desarrollado hidrogeles para la liberaci\'on sostenida de f\'armacos en el tratamiento de enfermedades como el c\'ancer, las enfermedades cardiovasculares y las infecciones.

En resumen, los hidrogeles polim\'ericos son materiales prometedores en el campo del drug delivery debido a su capacidad de encapsular y liberar f\'armacos de manera controlada. Su versatilidad y ajustabilidad qu\'imica permiten adaptar sus propiedades a las necesidades espec\'ificas de cada aplicaci\'on m\'edica. El uso de hidrogeles polim\'ericos en sistemas de administraci\'on de f\'armacos ofrece la posibilidad de mejorar la eficacia terap\'eutica y reducir los efectos secundarios no deseados de los medicamentos.


\section{enoque teorico}
