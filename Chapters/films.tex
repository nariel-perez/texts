...
\end{align}
\noindent en donde $n_\tau(\theta,z^\prime, z)$ es un par\'ametro de entrada que nos da el n\'umero de segmentos $\tau$ entre las capas $z$ and $z+ dz$ cuando el centro de masa del adsorbato se encuentra en el a configuraci\'on $\theta$ y en la posici\'on $z^\prime$.
...
Esto  muestra que para nuestro ba\~no de soluci\'on la principal inc\'ognita es la presi\'on osm\'otica: $\pi^b$.
...
\subsubsection{Captura y liberaci\'on de doxorrubicina en presencia de poliaminas}
