\chapter{Soluciones coloidales} \label{chapter:mc:soluciones}
	...
	Estas soluciones son capaces de responder a diversos est\'imulos externos como la temperatura, la presi\'on, el pH, la fuerza i\'onica y la presencia de diferentes biomol\'eculas.
...
\begin{align}
	R =  \left< R_s\right>\frac{e^{-\beta E_s}}{e^{-\beta E_S}+ e^{-\beta E_c}} + \left< R_s\right>\frac{e^{-\beta E_c}}{e^{-\beta E_s}+ e^{-\beta E_c}} 
\end{align}
