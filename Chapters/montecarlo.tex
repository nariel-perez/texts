\chapter{Nanogeles polim\'ericos: Soluciones coloidales} \label{chapter:mc:soluciones}
	...
	Del mismo modo se han estudiado soluciones coloidales, algunos estudios muestran a los nanogeles como part\'iculas esf\'ericas que interact\'uan \'unicamente con un potencial de n\'ucleo duro, es decir  esferas duras \cite{karg2019nanogels}.
	...
	En este nuevo cap\'itulo damos un paso m\'as adelante mostrando un estudio sistem\'atico de soluciones coloidales compuestos por nanogeles de P(NIPAm-co-MAA). Para este prop\'osito se har\'a uso de una metodolog\'ia basada en un algoritmo Monte Carlo en el cual se combinan potenciales de interacci\'on part\'icula-part\'icula y de la termodin\'amica de intra-nanogel desarrollada en \cite{perez2021thermodynamic}. 
	
	%%%% aqui motivación del capitulo
	%%% lo que sigue es lo que se hace, no la motivación.
	
	En este nuevo cap\'itulo se incorporan potenciales entre part\'iculas de la soluci\'on de tal forma de estudiar la respuesta a est\'imulo de las soluciones de nanoeles como funci\'on de la concentraci\'on de sus part\'iculas.
