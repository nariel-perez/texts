\chapter{Nanogel solution: thermodynamic theory} \label{cap:mc:soluciones}
	...
	\citet{alziyadi2023osmotic} utlizaron simulaciones de din\'amica molecuar con una teor\'ia de Posisson-Boltzmann para estudiar microgeles cargados superficialmente, los cuales se expanden al aumentar la concentraci\'on de microgeles y la concentraci\'on de sal.% Este comportamiento es sensible a la distribución de carga fija dentro del gel de red polimérica y depende de las concentraciones a granel tanto de los microgeles como de los iones de sal.
	...
	Los resultados obtenidos muestran que a medida que se aumenta la concentraci\'on de part\'iculas, estas disminuyen en su radio promedio. Esto se atribuye a las interacciones entre nanogeles. Para disminuir estas interacciones, cada nanogel disminuye su tama\~no.% Si bien hay un costo energético por disminuir su radio, respecto al de un sistema ideal, este costo es menor que el que se obtendría con los potenciales de Hertz-Yukawa.
