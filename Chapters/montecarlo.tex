...
\subsection{Simulaci\'on MC: Cambios en el radio}
...
\begin{figure*}[!tb]
	...
	\caption{Gr\'afico de densidad de probabilidad de tama\~no de la soluci\'on de  nanogeles... fracci\'on de volumen ocupada. nanogel m\'as flexible... 200 monomeros por cadena. 2e5 monomeros totales. radio medio aislado = 51 nm }
...
En la figura \ref{fig:mc:redf-gels-r} se muestra la densidad de  distribuci\'on radial para tres diferentes radios de nanogeles , pero todo provenientes de una misma curva de simulaci\'on. 
En el panel A y C se tratan nanogeles con el menor y mayor de los tama\~nos posibles $R_{min}$ y $R_{max}$ respectivamente. En cambio el panel B muestra a una soluci\'on con el radio de equilibrio $R_0$.
