...
Los hidrogeles tienen aplicaciones significativas en la mejora de la retenci\'n de agua y nutrientes en el suelo, lo cual es fundamental para incrementar la productividad agrícola y disminuir la dependencia del riego \cite{el2004radiation}. Estos materiales tambi\'en son \'utiles en la protecci\'on de plantas contra sequ\'ias y plagas.
...
En estas \'ultimas aplicaciones m\'edicas, en particular, los hidrogeles polim\'ericos han sido pioneros en su uso y han tenido un creciente inter\'es.
...
Adem\'as, su escaso tama\~no les permite responder r\'apidamente luego de recibir el est\'imulo \cite{tanaka1979kinetics}, que en el caso de la administraci\'on oral de f\'armacos los nanogeles con respuesta al pH se han considerado para la administraci\'on dado los cambios de pH que ocurren a lo largo del proceso digestivo.
...
Investigaciones recientes han explorado el uso de microgeles de poli(NIPAm-co-MAA) en dispositivos para la encapsulaci\'on y liberaci\'on del f\'armaco quimioterap\'eutico doxorrubicina \cite{Giussi2020, MartinezMoro2020, Pergushov2020}. La adici\'on de comon\'omero \'acido en estos microgeles introduce un mecanismo dependiente del pH para la captura y liberaci\'on eficiente de mol\'eculas cargadas opuestamente, haciendo estos sistemas de microgeles multifuncionales especialmente prometedores para el dise\~no de sistemas avanzados de administraci\'on de f\'armacos \cite{Liu2017}.
...
\section{Antecendentes metodol\'ogicos}
...
A lo largo de esta tesis se mostrar\'a como la TM fue extendida para el estudio de film de hidrogel  de poli\'acido para la captura de poliaminas, las cuales, como se demostrar\'a, funcionan como est\'imulo para la liberaci\'on de drogas terape\'uticas, en particular la doxorubicina, cap\'itulo \ref{Chapter-film}.
El estudio de la adsorci\'on de prote\'inas en nanogeles basados en PAH y PMAA, cap\'itulo \ref{Chapter-esfericas},  necesit\'o de un nuevo desarrollo de teor\'ia molecular capaz de adaptarse a la nueva descripci\'on del sistema.  Cambios en las configuraciones del hidrogel, sistema de coordenadas, interacci\'on analito-red polim\'erica. 
Para este estudio fue necesario el uso de simulaciones por din\'amica molecuar (DM)  para la obtenci\'on de las configuraciones de los nanogeles  polim\'ericos.
