...
\begin{align}
	\rho_\gamma(r)v_w = a_\gamma \exp{\left(-\beta \psi(r)q_\gamma\right)} \exp{\left(-\beta\pi(r) v_\gamma\right)}
...
\begin{align}
	\epsilon ~ \frac{1}{r^2} \frac{\partial}{\partial r}\left(r^2\frac{\partial \psi(r)}{\partial r}\right) = -\left<\rho_q(r)\right>
...
\begin{align}
	&  \lim_{r\to\infty}\psi(r) = 0 \label{eq:esf:contorno1} \\
...
Adem\'as, las condiciones de contorno expresadas en la ecuaci\'on \ref{eq:esf:contorno1} implican que:
\begin{align}
...
\begin{align}
	\rho_\gamma^b v_w = a_\gamma e^{-\beta\pi^bv_\gamma}
