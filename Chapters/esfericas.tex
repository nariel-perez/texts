...
Del mismo modo se pudieron explicar los cambios en el pH y como influye el porcentaje de monomeros protonables a dicha respuesta. La respuesta a la termperatura fue considera teniendo en cuenta monomeros de NIPAm.
...como afecta el grado de entrecruzamiento en todos los resultados anteriores.... 
Para estos microgeles se usaron drogas modelos, muyutilizadas para tratamientos anticancerigenos, para el estudio de adsorción: es decir de encapsulamiento. Se realizó y mostró un estudio sobre las mejores condiciones para optimizar estos sistemas como transportadores de drogas.
...
Para lograr esto se necesitó de diferentes configuraciones y una metodolog\'ia diferente \textcolor{red}{agregar en anexo}.
Este nuevo sistema nos permite acceder al comportamiento en el interior del nanogel 
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{M\'etodo: Teor\'ia Molecular}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
La secuencia y posici\'on de todos los carbonos $\alpha$ se toman de la estructura cristalogr\'afica obtenida de la base de datos de prote\'inas \addcite[berman2000protein]: 2B4Z para el citocromo c \addcite[mirkin2008high], IZNI para la insulina \addcite[bentley1976structure] y 3RGK para la mioglobina \addcite[hubbard1990x].
...
Estos pKa se toman de datos experimentales y representan valores promedio sobre un gran n\'umero de proteínas \addcite[grimsley2009summary].
...
A partir del gr\'afico, obtenemos los valores 9.65 (9.6 \addcite[hristova2019isoelectric]), 5.5 (5.3 \addcite[guckeisen2019isoelectric]), 7.15 (7.2 \addcite[batys2020myoglobin]) para el pI del citocromo c, insulina y mioglobina respectivamente;
