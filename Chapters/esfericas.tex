...
El sub\'indice $\gamma$ toma en cuenta las mol\'eculas de agua y sus iones (hidronio e hidr\'oxido), y los iones disociados de la sal ($Na^+$, $Cl^-$). $G(r)$ es la constante de simetr\'ia de nuestro sistema, en particular para cada para $r$: $G(r) =4\pi r^2$. %Esta \'utima se ejemplificara de mejor forma en la secci\'on del modelado molecular.
...
Para completar el gran potencial de la  ecuaci\'on  \ref{eq:esf:semicano}, se tiene en cuenta el intercambio de especies m\'oviles:
...
mientras tanto, para la estructura tipo SF, el deshinchamiento con la disminuci\'on del pH que se ve en la figura \ref{fig:esf:gel-charge-MAA-AH}B es consistente con un desplazamiento hacia adentro del pol\'imero %(ver \cref*{fig:AHseg_si}C) .
...
\begin{figure}[!htb]
\includegraphics[width=0.95\textwidth]{Figures/graphs-gel2/ad-maa-pH-proteins.pdf}
...
\begin{figure}[!htb]
     \centering
     \includegraphics[width=0.55\textwidth]{Figures/graphs-gel2/cito-adsr-pmf.pdf}
...
\begin{figure}[!htb]
     \centering
     \includegraphics[width=0.55\textwidth]{Figures/graphs-gel2/gamma-salts-cito.pdf}
...
\begin{figure}[!htb]
    \centering
    \includegraphics[width=0.95\textwidth]{Figures/graphs-gel2/insu-PAH.pdf}
