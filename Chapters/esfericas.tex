...
En esta ocasi\'on, dado que $\psi^b = 0$, se observa que los funcionales en el bulk de la soluci\'on se encuentran establecidos por el potencial de presi\'on $\pi^b$ y la electro-neutralidad del sistema, siendo estas nuestras variables a resolver.
...
\begin{figure}[!htb]
     \centering
     \includegraphics[width=0.55\textwidth]{Figures/graphs-gel2/dist-MAA.pdf}
...
\begin{figure}[!htb]
	\centering
	\includegraphics[width=0.55\textwidth]{Figures/graphs-gel2/allseg_SI.pdf}
...
Por otro lado, las interacciones del citocromo c con los nanogeles RF y SF se extienden m\'as lejos, hasta $55-60$ nm. En el interior del nanogel, estas interacciones son m\'as d\'ebiles que las de la estructura CF. La energ\'ia libre de adsorci\'on es aproximadamente $-6 k_BT$, y se mantiene aproximadamente constante dentro del nanogel RF.
...
\begin{figure}[!htb]
    \centering
    \includegraphics[width=0.55\textwidth]{Figures/graphs-gel2/insu-ads-pmf.pdf}
